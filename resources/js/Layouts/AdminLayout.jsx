...
export default function AdminLayout({ children }) {
  ...
  const navigationItems = [
    ...
    { href: '/admin/theme-settings', icon: 'themes', label: 'Mövzu', color: theme.accent_color },
    ...
    { href: '/admin/mail-settings', icon: 'control-panel', label: 'E-poçt', color: '#2563eb' },
  ...
  return (
    ...
    >
        ...
        <div className="max-w-screen-2xl mx-auto w-full relative">
          <div className="flex items-center justify-between px-3 md:px-4 py-3 gap-2 flex-wrap lg:flex-nowrap">
            ...
            <div className="flex items-center space-x-2 md:space-x-3">
              ...
              >
                <div className="w-10 h-10 md:w-12 md:h-12 rounded-lg flex items-center justify-center" style={{ backgroundColor: theme.primary_color }}>
                  <Icon name="nav_dashboard" size={24} color="white" />
                </div>
                <span className="text-xl md:text-2xl font-bold hidden sm:block">Admin Panel</span>
              </Link>
            </div>
      ...
      {mounted && showNotif && createPortal(
        ...
        {/* Footer */}
        <Footer footerSettings={footerSettings} className={darkMode ? 'dark:bg-gray-800/80 dark:border-gray-700' : ''} />
    </div>
  );
}
